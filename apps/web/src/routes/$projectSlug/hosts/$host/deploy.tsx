...
function DeployOperate() {
  ...
  useEffect(() => {
    ...
    const channel = hostCfg?.selfUpdate?.channel || "prod"
    setManifestPath(`deploy/${host}/${channel}/1.json`)
  }, [host, hostCfg?.selfUpdate?.channel, manifestPath])
          ...
          <div className="rounded-lg border bg-card p-6 space-y-4">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <Input value={manifestPath} onChange={(e) => setManifestPath(e.target.value)} placeholder={`deploy/${host}/prod/<releaseId>.json`} />
                <div className="text-xs text-muted-foreground">
                  Recommended: a signed release manifest (v1) generated by CI.
                </div>
              </div>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                <Label>Expected rev (optional)</Label>
