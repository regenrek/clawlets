...
function pickFixLink(
  ...
  if (label.includes("fleet policy") || label.includes("fleet gateways") || label.includes("services.clawdbotfleet.enable")) return toFleet()
  ...
  if (gatewayId && label.includes("clawdbot security")) return toGatewaySettings(gatewayId)
