...
- `provisioning.sshPubkeyFile` (optional): local path override to a `.pub` used for provisioning on the bootstrap machine (advanced; prefer `fleet.sshAuthorizedKeys`)
