...
- **No runner logs:** default file is `~/.clawlets/runtime/runner/<projectId>/<runnerName>/logs/runner/<projectId>-<runnerName>.jsonl` (JSONL; owner-only perms).
