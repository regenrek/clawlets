...
## Orchestrator (`clf`, optional plugin)

CLF is opt-in. See plugin docs for deployment, status checks, and job inspection:

- [CLF Orchestrator](/plugins/clf-orchestrator)
- [CLF Queue](/plugins/clf-queue)
